...
#define ACTIVE_LIGHT_SENSOR_REQUIRED true//Macro to include active light sensor TSL2651
#define PASSIVE_LIGHT_SENSOR_REQUIRED false
...
#define Cycle_Period 4.25  //defining cycle period in seconds
...
/*Macros and initializations pertaining to timer functions*/
